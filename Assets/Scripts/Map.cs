...
namespace CityGeneration
{
    public class Map : MonoBehaviour
    {
        ...
        [SerializeField] private int sBuildingsPer; //Small Building Persentage
        [SerializeField] private int mBuildingsPer;
        [SerializeField] private int lBuildingsPer;
        ...
        private void InitializeNodes()
        {
            ...
            for (int x = 0; x < this.x; x++)
            {
                for (int y = 0; y < this.y; y++)
                {
                    ...
                    node.transform.position = new Vector3(offset * (x + 0.5f - (this.x) / 2), 0,
                        offset * (y + 0.5f - this.y / 2));
